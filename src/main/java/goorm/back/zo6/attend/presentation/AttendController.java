...
public class AttendController {
    ...
    public ResponseEntity<ResponseDto<ConferenceInfoResponse>> getAttendWithReservationByToken(@AuthenticationPrincipal LoginUser loginUser,
                                                                                               @RequestParam("conferenceId")Long conferenceId){
        Long userId = loginUser.getId();
        ConferenceInfoResponse attendResponses = attendService.findAllByToken(userId, conferenceId);
