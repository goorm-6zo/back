...
class AttendControllerTest {
    ...
    void setUp() {
        ...
        testConferenceA = Conference.builder().name("컨퍼런스A").capacity(10).startTime(LocalDateTime.now()).endTime(LocalDateTime.now()).description("좋은 컨퍼런스A").hasSessions(true).location("서울 법성포A").imageKey("test.png").isActive(true).area("테스트 룸").build();
        testConferenceB = Conference.builder().name("컨퍼런스B").capacity(10).startTime(LocalDateTime.now()).endTime(LocalDateTime.now()).description("좋은 컨퍼런스B").hasSessions(false).location("서울 법성포B").imageKey("test.png").isActive(true).area("테스트 룸").build();
        testConferenceC = Conference.builder().name("컨퍼런스C").capacity(10).startTime(LocalDateTime.now()).endTime(LocalDateTime.now()).description("좋은 컨퍼런스C").hasSessions(false).location("서울 법성포C").imageKey("test.png").isActive(true).area("테스트 룸").build();
